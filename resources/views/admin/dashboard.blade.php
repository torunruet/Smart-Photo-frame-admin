...
<div class="p-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <!-- Total Frames -->
        <a href="{{ route('admin.frames.index') }}" class="bg-white rounded-lg shadow-md p-6 flex items-center justify-between hover:shadow-lg transition-shadow duration-200">
             <div>
                <p class="text-sm font-medium text-gray-500">Total Frames</p>
                <p class="text-3xl font-bold text-gray-900 mt-1">{{ \App\Models\Frame::count() }}</p>
            </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="space-y-4 text-gray-600">
            ...
            {{-- <div class="flex items-center space-x-3">
                ...
                <span>User 'John Doe' added a new device 'Device X'.</span>
