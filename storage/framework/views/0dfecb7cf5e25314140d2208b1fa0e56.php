...
<div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="max-w-2xl mx-auto">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-semibold text-gray-900">Add New Device</h1>
            <a href="<?php echo e(route('admin.devices.index')); ?>" class="text-indigo-600 hover:text-indigo-900">Back to Devices</a>
        </div>

        <div class="bg-white shadow sm:rounded-lg">
            <form action="<?php echo e(route('admin.devices.store')); ?>" method="POST" class="space-y-6 p-6">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\6.3.25\frameX-kiosk-system-admin\resources\views/admin/devices/create.blade.php ENDPATH**/ ?>